; ModuleID = '/Users/haohua/Documents/GitHub/cs-nano-projects/cscd70-compiler-optimization/assignment1-intro-llvm/FunctionInfo/test/Loop.c'
source_filename = "/Users/haohua/Documents/GitHub/cs-nano-projects/cscd70-compiler-optimization/assignment1-intro-llvm/FunctionInfo/test/Loop.c"
...
attributes #1 = { nofree norecurse nosync nounwind ssp uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "tune-cpu"="generic" }
...
!4 = !{!"clang version 14.0.0 (https://github.com/llvm/llvm-project.git e7298464c5d004a119583cdb8a120dc3d968508d)"}
!5 = !{!6, !6, i64 0}
!6 = !{!"int", !7, i64 0}
