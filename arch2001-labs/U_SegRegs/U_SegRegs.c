...
void read_cs(unsigned short* cs){
    __asm__ __volatile__ ("mov %cs, (%rdi)"); 
}

void read_ds(unsigned short* ds){
    __asm__ __volatile__ ("mov %ds, (%rdi)"); 
}
void read_ss(unsigned short* ss){
    __asm__ __volatile__ ("mov %ss, (%rdi)"); 
}

void read_es(unsigned short* es){
    __asm__ __volatile__ ("mov %es, (%rdi)"); 
}

void read_fs(unsigned short* fs){
    __asm__ __volatile__ ("mov %fs, (%rdi)"); 
}

void read_gs(unsigned short* gs){
    __asm__ __volatile__ ("mov %gs, (%rdi)"); 
}
