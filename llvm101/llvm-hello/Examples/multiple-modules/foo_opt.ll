...
enter:
  ...
  %3 = load i32, i32* @CounterFor_main, align 4
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @ResultFormatStrIR, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @1, i32 0, i32 0), i32 %3)
  ret void
}
